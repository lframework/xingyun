...
public class CustomerSettleSheetServiceImpl extends
  ...
  @Transactional(rollbackFor = Exception.class)
  @Override
  public void approvePass(ApprovePassCustomerSettleSheetVo vo, String userId) {
  ...
  @Transactional(rollbackFor = Exception.class)
  @Override
  public String directApprovePass(CreateCustomerSettleSheetVo vo, String userId) {
  ...
  @Transactional(rollbackFor = Exception.class)
  @Override
  public void approveRefuse(ApproveRefuseCustomerSettleSheetVo vo, String userId) {

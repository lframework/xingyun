...
@LocalTCC
public interface ISaleOutSheetTccService {
   ...
   * @return
   */
  @TwoPhaseBusinessAction(name = "saleOutSheetTccServiceImpl", commitMethod = "commitSetUnSettle", rollbackMethod = "rollbackSetUnSettle")
   ...
   * @return
   */
  @TwoPhaseBusinessAction(name = "saleOutSheetTccServiceImpl", commitMethod = "commitSetPartSettle", rollbackMethod = "rollbackSetPartSettle")
   ...
   * @return
   */
  @TwoPhaseBusinessAction(name = "saleOutSheetTccServiceImpl", commitMethod = "commitSetSettled", rollbackMethod = "rollbackSetSettled")

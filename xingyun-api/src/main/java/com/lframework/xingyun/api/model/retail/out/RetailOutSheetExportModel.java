...
public class RetailOutSheetExportModel extends BaseBo<RetailOutSheetDto> implements ExcelModel {
    ...
    public RetailOutSheetExportModel(RetailOutSheetDto dto) {

        super(dto);
    }

    @Override
    public <A> BaseBo<RetailOutSheetDto> convert(RetailOutSheetDto dto) {

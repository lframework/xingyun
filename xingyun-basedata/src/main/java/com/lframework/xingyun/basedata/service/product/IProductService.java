...
public interface IProductService extends BaseMpService<Product> {
   ...
   * @return
   */
  PageResult<PurchaseProductDto> queryPurchaseByCondition(Integer pageIndex, Integer pageSize,
      String condition);
   ...
   * @return
   */
  PageResult<PurchaseProductDto> queryPurchaseList(Integer pageIndex, Integer pageSize,
   ...
   * @return
   */
  PageResult<SaleProductDto> querySaleByCondition(Integer pageIndex, Integer pageSize,
      String condition);
   ...
   * @return
   */
  PageResult<SaleProductDto> querySaleList(Integer pageIndex, Integer pageSize,
   ...
   * @return
   */
  PageResult<PreTakeStockProductDto> queryPreTakeStockByCondition(Integer pageIndex,
   ...
   * @return
   */
  PageResult<StockCostAdjustProductDto> queryStockCostAdjustByCondition(Integer pageIndex,
   ...
   * @return
   */
  PageResult<StockCostAdjustProductDto> queryStockCostAdjustList(Integer pageIndex,

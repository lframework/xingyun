...
ALTER TABLE `gen_custom_list` ADD COLUMN `create_by_id` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '创建人ID' AFTER `create_by`;
ALTER TABLE `gen_custom_list_category` ADD COLUMN `create_by_id` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '创建人ID' AFTER `create_by`;
...
ALTER TABLE `gen_data_obj` ADD COLUMN `create_by_id` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '创建人ID' AFTER `create_by`;
ALTER TABLE `gen_data_obj_category` ADD COLUMN `create_by_id` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '创建人ID' AFTER `create_by`;
ALTER TABLE `gen_datasource` ADD COLUMN `create_by_id` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '创建人ID' AFTER `create_by`;
ALTER TABLE `gen_datasource_template` ADD COLUMN `create_by_id` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '创建人ID' AFTER `create_by`;
...
UPDATE gen_custom_list c left join sys_user u on u.id = c.create_by set c.create_by_id = c.create_by, c.create_by = u.name;
UPDATE gen_custom_list_category c left join sys_user u on u.id = c.create_by set c.create_by_id = c.create_by, c.create_by = u.name;
...
UPDATE gen_data_obj c left join sys_user u on u.id = c.create_by set c.create_by_id = c.create_by, c.create_by = u.name;
UPDATE gen_data_obj_category c left join sys_user u on u.id = c.create_by set c.create_by_id = c.create_by, c.create_by = u.name;
UPDATE gen_datasource c left join sys_user u on u.id = c.create_by set c.create_by_id = c.create_by, c.create_by = u.name;
UPDATE gen_datasource_template c left join sys_user u on u.id = c.create_by set c.create_by_id = c.create_by, c.create_by = u.name;
...
ALTER TABLE `gen_custom_list` ADD COLUMN `update_by_id` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '修改人ID' AFTER `update_by`;
ALTER TABLE `gen_custom_list_category` ADD COLUMN `update_by_id` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '修改人ID' AFTER `update_by`;
...
ALTER TABLE `gen_data_obj` ADD COLUMN `update_by_id` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '修改人ID' AFTER `update_by`;
ALTER TABLE `gen_data_obj_category` ADD COLUMN `update_by_id` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '修改人ID' AFTER `update_by`;
ALTER TABLE `gen_datasource` ADD COLUMN `update_by_id` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '修改人ID' AFTER `update_by`;
ALTER TABLE `gen_datasource_template` ADD COLUMN `update_by_id` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '修改人ID' AFTER `update_by`;
...
UPDATE gen_custom_list c left join sys_user u on u.id = c.update_by set c.update_by_id = c.update_by, c.update_by = u.name;
UPDATE gen_custom_list_category c left join sys_user u on u.id = c.update_by set c.update_by_id = c.update_by, c.update_by = u.name;
...
UPDATE gen_data_obj c left join sys_user u on u.id = c.update_by set c.update_by_id = c.update_by, c.update_by = u.name;
UPDATE gen_data_obj_category c left join sys_user u on u.id = c.update_by set c.update_by_id = c.update_by, c.update_by = u.name;
UPDATE gen_datasource c left join sys_user u on u.id = c.update_by set c.update_by_id = c.update_by, c.update_by = u.name;
UPDATE gen_datasource_template c left join sys_user u on u.id = c.update_by set c.update_by_id = c.update_by, c.update_by = u.name;

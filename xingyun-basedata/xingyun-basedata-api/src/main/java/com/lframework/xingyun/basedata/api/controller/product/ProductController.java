...
import com.lframework.xingyun.basedata.api.bo.product.info.GetProductBo;
import com.lframework.xingyun.basedata.api.bo.product.info.QueryProductBo;
import com.lframework.xingyun.basedata.api.bo.product.info.purchase.PurchaseProductBo;
import com.lframework.xingyun.basedata.api.bo.product.info.retail.RetailProductBo;
import com.lframework.xingyun.basedata.api.bo.product.info.sale.SaleProductBo;
import com.lframework.xingyun.basedata.api.bo.product.info.stock.adjust.StockCostAdjustProductBo;
import com.lframework.xingyun.basedata.api.bo.product.info.stock.take.pre.PreTakeStockProductBo;
import com.lframework.xingyun.basedata.api.bo.product.info.stock.take.sheet.TakeStockSheetProductBo;
import com.lframework.xingyun.basedata.api.excel.product.ProductImportListener;
import com.lframework.xingyun.basedata.api.excel.product.ProductImportModel;
...
public class ProductController extends DefaultBaseController {
  ...
  @Autowired
  private TakeStockPlanFeignClient takeStockPlanFeignClient;
  ...
  public InvokeResult<List<TakeStockSheetProductBo>> searchProducts(
    ...
    TakeStockPlan takeStockPlan = takeStockPlanFeignClient.getById(planId).getData();
  ...
  public InvokeResult<PageResult<TakeStockSheetProductBo>> queryProductList(
    ...
    TakeStockPlan takeStockPlan = takeStockPlanFeignClient.getById(vo.getPlanId()).getData();
    if (takeStockPlan.getTakeType() == TakeStockPlanType.SIMPLE) {
      vo.setPlanId(null);
    }

...
public class SupplierServiceImpl implements ISupplierService {
    ...
    public void update(UpdateSupplierVo vo) {
        ...
        LambdaUpdateWrapper<Supplier> updateWrapper = Wrappers.lambdaUpdate(Supplier.class)
                ...
                .set(Supplier::getDeliveryCycle, vo.getDeliveryCycle()).set(Supplier::getSettleType, EnumUtil.getByCode(SettleType.class, vo.getSettleType()))
    ...
    @Override
    public PageResult<SupplierDto> selector(Integer pageIndex, Integer pageSize, QuerySupplierSelectorVo vo) {

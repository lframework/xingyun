...
import com.lframework.xingyun.sc.facade.enums.SaleOutSheetStatus;
...
import com.lframework.xingyun.sc.facade.vo.sale.out.SaleOutProductVo;
...
public class SaleOutSheetServiceImpl extends BaseMpServiceImpl<SaleOutSheetMapper, SaleOutSheet>
  ...
  public GetPaymentDateDto getPaymentDate(String customerId) {
    ...
    Customer customer = customerFeignClient.findById(customerId).getData();
  ...
  public int setUnSettle(String id) {
    ...
    Wrapper<SaleOutSheet> updateWrapper = Wrappers.lambdaUpdate(SaleOutSheet.class)
        .set(SaleOutSheet::getSettleStatus, SettleStatus.UN_SETTLE)
        .set(SaleOutSheet::getOriSettleStatus, SettleStatus.PART_SETTLE)
        .eq(SaleOutSheet::getId, id)
        .eq(SaleOutSheet::getSettleStatus, SettleStatus.PART_SETTLE)
        .isNull(SaleOutSheet::getOriSettleStatus);

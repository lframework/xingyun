...
public class GetPurchaseConfigBo extends BaseBo<PurchaseConfig> {
     ...
     * 采购订单关联的审批流程编号
     */
    @Schema(description = "采购订单关联的审批流程编号")

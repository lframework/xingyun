...
public interface IStoreCenterService extends BaseService {
     ...
     * @return
     */
    PageResult<StoreCenterDto> selector(Integer pageIndex, Integer pageSize, QueryStoreCenterSelectorVo vo);
}

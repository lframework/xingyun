...
@Data
public class ProductCategoryPropertyDefinitionModelorDto implements BaseDto, Serializable {
   ...
   */
  private List<ProductCategoryPropertyItemModelorDto> items;
  ...
  @Data
  public static class ProductCategoryPropertyItemModelorDto implements BaseDto, Serializable {

...
public class TakeStockSheetFullBo extends BaseBo<TakeStockSheetFullDto> {
  ...
  protected void afterInit(TakeStockSheetFullDto dto) {
    ...
    if (!StringUtil.isBlank(dto.getPreSheetId())) {
      IPreTakeStockSheetService preTakeStockSheetService = ApplicationUtil
          .getBean(IPreTakeStockSheetService.class);
  ...
  public static class SheetDetailBo extends BaseBo<TakeStockSheetFullDto.SheetDetailDto> {
    ...
    protected void afterInit(TakeStockSheetFullDto.SheetDetailDto dto) {
      ...
      if (config.getShowStock()) {
        ITakeStockPlanDetailService takeStockPlanDetailService = ApplicationUtil
            .getBean(ITakeStockPlanDetailService.class);
        GetTakeStockPlanDetailProductDto planDetail = takeStockPlanDetailService
            .getByPlanIdAndProductId(this.planId, this.productId);

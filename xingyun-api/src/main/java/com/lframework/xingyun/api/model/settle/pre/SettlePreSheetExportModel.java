...
public class SettlePreSheetExportModel extends BaseBo<SettlePreSheetDto> implements ExcelModel {
  ...
  public SettlePreSheetExportModel(SettlePreSheetDto dto) {

    super(dto);
  }

  @Override
  public <A> BaseBo<SettlePreSheetDto> convert(SettlePreSheetDto dto) {

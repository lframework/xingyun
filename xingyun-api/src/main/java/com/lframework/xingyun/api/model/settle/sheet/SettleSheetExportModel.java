...
public class SettleSheetExportModel extends BaseBo<SettleSheetDto> implements ExcelModel {
  ...
  public SettleSheetExportModel(SettleSheetDto dto) {

    super(dto);
  }

  @Override
  public <A> BaseBo<SettleSheetDto> convert(SettleSheetDto dto) {

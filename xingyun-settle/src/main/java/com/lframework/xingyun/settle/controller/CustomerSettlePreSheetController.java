...
public class CustomerSettlePreSheetController extends DefaultBaseController {
   ...
   * 直接审核通过客户预付款单
   */
  @Operation(summary = "直接审核通过客户预付款单")
  @HasPermission({"customer-settle:pre-sheet:approve"})

...
@LocalTCC
public interface IPurchaseReturnTccService {
   ...
   * @return
   */
  @TwoPhaseBusinessAction(name = "purchaseReturnTccServiceImpl", commitMethod = "commitSetUnSettle", rollbackMethod = "rollbackSetUnSettle")
   ...
   * @return
   */
  @TwoPhaseBusinessAction(name = "purchaseReturnTccServiceImpl", commitMethod = "commitSetPartSettle", rollbackMethod = "rollbackSetPartSettle")
   ...
   * @return
   */
  @TwoPhaseBusinessAction(name = "purchaseReturnTccServiceImpl", commitMethod = "commitSetSettled", rollbackMethod = "rollbackSetSettled")

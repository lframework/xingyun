...
public interface ISettleFeeSheetService extends BaseMpService<SettleFeeSheet> {
   ...
   * @return
   */
  PageResult<SettleFeeSheetDto> query(Integer pageIndex, Integer pageSize,
   ...
   * @return
   */
  List<SettleFeeSheetDto> getApprovedList(String supplierId, LocalDateTime startTime,

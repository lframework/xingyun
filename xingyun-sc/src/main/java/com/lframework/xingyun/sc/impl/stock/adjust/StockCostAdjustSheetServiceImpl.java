...
public class StockCostAdjustSheetServiceImpl extends
  ...
  @OpLog(type = ScOpLogType.STOCK_ADJUST, name = "新增库存成本调整单，ID：{}", params = {"#id"})
  ...
  @OpLog(type = ScOpLogType.STOCK_ADJUST, name = "修改库存成本调整单，ID：{}", params = {"#id"})
  ...
  @OpLog(type = ScOpLogType.STOCK_ADJUST, name = "删除库存成本调整单，ID：{}", params = {"#id"})
  ...
  @OpLog(type = ScOpLogType.STOCK_ADJUST, name = "审核通过库存成本调整单，ID：{}", params = {"#vo.id"})
  ...
  @OpLog(type = ScOpLogType.STOCK_ADJUST, name = "审核拒绝库存成本调整单，ID：{}", params = {"#id"})

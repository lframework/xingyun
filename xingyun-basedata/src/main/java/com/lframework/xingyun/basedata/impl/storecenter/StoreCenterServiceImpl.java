...
public class StoreCenterServiceImpl implements IStoreCenterService {
    ...
    @Override
    public PageResult<StoreCenterDto> query(Integer pageIndex, Integer pageSize, QueryStoreCenterVo vo) {
    ...
    @Override
    public PageResult<StoreCenterDto> selector(Integer pageIndex, Integer pageSize, QueryStoreCenterSelectorVo vo) {

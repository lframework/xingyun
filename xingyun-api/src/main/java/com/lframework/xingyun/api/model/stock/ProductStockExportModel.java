...
public class ProductStockExportModel extends BaseBo<ProductStockDto> implements ExcelModel {
    ...
    public ProductStockExportModel(ProductStockDto dto) {

        super(dto);
    }

    @Override
    public <A> BaseBo<ProductStockDto> convert(ProductStockDto dto) {

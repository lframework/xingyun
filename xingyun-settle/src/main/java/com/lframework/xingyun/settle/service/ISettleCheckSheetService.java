...
public interface ISettleCheckSheetService extends BaseService {
     ...
     * @return
     */
    PageResult<SettleCheckSheetDto> query(Integer pageIndex, Integer pageSize, QuerySettleCheckSheetVo vo);
     ...
     * @return
     */
    List<SettleCheckSheetDto> getApprovedList(String supplierId, LocalDateTime startTime, LocalDateTime endTime);

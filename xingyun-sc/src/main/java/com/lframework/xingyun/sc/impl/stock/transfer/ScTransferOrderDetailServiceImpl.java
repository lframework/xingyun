...
public class ScTransferOrderDetailServiceImpl
  ...
  @Override
  public int receive(String orderId, String skuId, BigDecimal receiveNum, BigDecimal receiveAmount) {
    return getBaseMapper().receive(orderId, skuId, receiveNum, receiveAmount);
  }

...
@LocalTCC
public interface ISaleReturnTccService {
   ...
   * @return
   */
  @TwoPhaseBusinessAction(name = "saleReturnTccServiceImpl", commitMethod = "commitSetUnSettle", rollbackMethod = "rollbackSetUnSettle")
   ...
   * @return
   */
  @TwoPhaseBusinessAction(name = "saleReturnTccServiceImpl", commitMethod = "commitSetPartSettle", rollbackMethod = "rollbackSetPartSettle")
   ...
   * @return
   */
  @TwoPhaseBusinessAction(name = "saleReturnTccServiceImpl", commitMethod = "commitSetSettled", rollbackMethod = "rollbackSetSettled")

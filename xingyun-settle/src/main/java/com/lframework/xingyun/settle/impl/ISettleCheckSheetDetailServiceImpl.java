...
@Service
public class ISettleCheckSheetDetailServiceImpl extends
    BaseMpServiceImpl<SettleCheckSheetDetailMapper, SettleCheckSheetDetail> implements
    ISettleCheckSheetDetailService {

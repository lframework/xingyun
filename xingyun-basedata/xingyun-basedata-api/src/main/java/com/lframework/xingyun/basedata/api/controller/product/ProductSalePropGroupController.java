...
import com.lframework.xingyun.basedata.api.bo.product.saleprop.GetProductSalePropGroupBo;
import com.lframework.xingyun.basedata.api.bo.product.saleprop.QueryProductSalePropGroupBo;
...
public class ProductSalePropGroupController extends DefaultBaseController {
  ...
  public InvokeResult<PageResult<QueryProductSalePropGroupBo>> query(
    ...
    PageResult<ProductSalePropGroup> pageResult = productSalePropGroupService.query(
        getPageIndex(vo),
        getPageSize(vo), vo);

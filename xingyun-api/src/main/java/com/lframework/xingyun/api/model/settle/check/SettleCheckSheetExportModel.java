...
public class SettleCheckSheetExportModel extends BaseBo<SettleCheckSheetDto> implements ExcelModel {
    ...
    public SettleCheckSheetExportModel(SettleCheckSheetDto dto) {

        super(dto);
    }

    @Override
    public <A> BaseBo<SettleCheckSheetDto> convert(SettleCheckSheetDto dto) {
